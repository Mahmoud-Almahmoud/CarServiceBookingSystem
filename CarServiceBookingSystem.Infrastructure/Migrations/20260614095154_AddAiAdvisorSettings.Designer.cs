...
namespace CarServiceBookingSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260614095154_AddAiAdvisorSettings")]
    partial class AddAiAdvisorSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.AiConversationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.AiServiceRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FeedbackValue");

                    b.HasIndex("ServiceId");

                    b.ToTable("AiServiceRecommendations", (string)null);
                });
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.AiConversationMessage", b =>
                {
                    b.HasOne("CarServiceBookingSystem.Domain.Entities.AiConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CarServiceBookingSystem.Domain.Entities.AiServiceRecommendation", b =>
                {
                    b.HasOne("CarServiceBookingSystem.Domain.Entities.AiConversationMessage", "AssistantMessage")
                        .WithMany()
