...
public class UpdateTechnicianUnavailableDateRequestValidator : AbstractValidator<UpdateTechnicianUnavailableDateRequest>
{
    public UpdateTechnicianUnavailableDateRequestValidator()
    {
        RuleFor(x => x.EndDate)
