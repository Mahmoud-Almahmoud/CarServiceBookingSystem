...
public class UpdateCancellationPolicyRuleRequestValidator : AbstractValidator<UpdateCancellationPolicyRuleRequest>
{
    public UpdateCancellationPolicyRuleRequestValidator()
    {
