...
public interface IAuthService
{
    ...
    Task<ApiResponse<string>> EnableTwoFactorAsync(VerifyTwoFactorRequest request, CancellationToken cancellationToken = default);
    Task<ApiResponse<AuthResponse>> LoginWithTwoFactorAsync(LoginTwoFactorRequest request);
    Task<ApiResponse<string>> DisableTwoFactorAsync(DisableTwoFactorRequest request, CancellationToken cancellationToken = default);
