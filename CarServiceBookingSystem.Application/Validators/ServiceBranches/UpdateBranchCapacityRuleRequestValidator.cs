...
public class UpdateBranchCapacityRuleRequestValidator : AbstractValidator<UpdateBranchCapacityRuleRequest>
{
    public UpdateBranchCapacityRuleRequestValidator()
    {
